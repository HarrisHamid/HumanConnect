...
const steps = [
  {
    ...
    body: "Day or night, the agent picks up by the second ring. No hold music, no phone tree — a conversation.",
  ...
  {
    icon: CalendarCheck,
    title: "It books, not just chats",
    body: "Checks real availability and books straight into your calendar. Reschedules, cancellations, and routine questions — handled end-to-end.",
    color: "from-sky-500/10 to-sky-400/5 border-sky-200/60",
    iconBg: "from-accent/15 to-accent/5 border-accent/20 text-accent",
  },
  {
    icon: Brain,
    title: "Your staff stays in charge",
    body: "Anything clinical or unusual gets a warm handoff with full context. Every call lands on your dashboard with a summary.",
